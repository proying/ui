...
CUIString CRichEditUI::GetText() const
{
...
CUIString CRichEditUI::GetSelText() const
{
...
CUIString CRichEditUI::GetTextRange(long nStartChar, long nEndChar) const
{
    TEXTRANGEW tr = { 0 };
...
CUIString CRichEditUI::GetLine(int nIndex, int nMaxLength) const
{
    LPWSTR lpText = NULL;
