...
#ifndef __FILET__
#define __DirectUI_STR2WSTR(str)	L##str
#define _DirectUI_STR2WSTR(str)	__DirectUI_STR2WSTR(str)
#ifdef _UNICODE
#define __FILET__	_DirectUI_STR2WSTR(__FILE__)
#define __FUNCTIONT__	_DirectUI_STR2WSTR(__FUNCTION__)
#else
